package pl.metaclass.food.ordering.system.kafka.consumer.config;
...
import pl.metaclass.food.ordering.system.kafka.data.KafkaConfigData;
import pl.metaclass.food.ordering.system.kafka.data.KafkaConsumerConfigData;
import pl.metaclass.food.ordering.system.kafka.data.KafkaProducerConfigData;
...
@Configuration
public class KafkaConsumerConfig<K extends Serializable, V extends SpecificRecordBase> implements Serializable {
